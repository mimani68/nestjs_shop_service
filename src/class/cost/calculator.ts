...
export class ProductCostCalculator {
    ...
    public calculateCost(productType: string, shippingType?: string, skuCosts?: number): number {
      if (productType === 'POD') {
        ...
        if (shippingType === 'Self-Managed Shipping') {
        ...
        } else if (shippingType === 'Easy Post Shipping') {
          // Easy Post Shipping
